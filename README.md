...
No te preocupes, el diseño de lo que necesitamos por el momento está hecho, ya que el trabajo del diseñador ya ha sido realizado. Tu tarea será convertir ese diseño en una `web-app` funcional, `mobile first`, e ir añadiendo funcionalidades de forma progresiva.
